...
3.	Para el departamento de logística:
	...
	A.	Es necesario saber la cantidad camiones que harian falta para transportar los materiales que 
    se utilizarán para la construcción de un edificio. Para ello, se ingresa la cantidad de toneladas necesarias de materiales a transportar. 
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        alert ("", f"Se necesitan {camiones} para transportar {toneladas} Kg")
    ...
    def btn_tiempo_llegada_on_click(self):
        ...
        alert("", f"Los camiones tardaran {round(tiempo,2)} hs")
